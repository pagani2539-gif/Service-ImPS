...
│           └── mapDataLogger.js     # คำนวณ/จำแนกรถ, ESAL, กฎคัดกรอง (GVW/length) และ straddling merge
├── scripts/
